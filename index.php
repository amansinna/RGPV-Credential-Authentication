...
$postdata = 'ScriptManager1=UserLogin1$UpdPnlLogin|UserLogin1$btnLogin&__LASTFOCUS=&__EVENTTARGET=&__EVENTARGUMENT=&__VIEWSTATE='.$viewState.'&UserLogin1$txtUserName='.$username.'&UserLogin1$txtPassword='.$password.'&UserLogin1$btnLogin.x=15&UserLogin1$btnLogin.y=9';
